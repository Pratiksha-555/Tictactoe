...
def play():
	...
	head = Button(menu, text="---Welcome to tic-tac-toe---",
				...
				fg="yellow",  font='summer', bd=5)

	B1 = Button(menu, text="Play With System", command=wpc,
				activeforeground='blue',
				activebackground="yellow", bg="blue",
				fg="yellow", font='summer', bd=5)

	B2 = Button(menu, text="Play With Friend", command=wpl, activeforeground='red',
